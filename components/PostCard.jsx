...
function PostCard({post}) {
  console.log(post);
  return (
    <div className='bg-blue shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
      ...
      <p className='text-center text-lg text-gray-700 font-normal px-4 lg:px-20 mb-8 block'>{post.excerpt}</p>
